...
class BaseController(metaclass=ABCMeta):
    ...
    @abstractmethod
    def get_accel_diff(self, env, pos, vel):
        """ Differentiable version of get_accel""" 
        pass

    @abstractmethod
    def get_d_accel(self, env):
        """ Return the derivative of the acceleration wtr position and velocity.
        Returns dx,dv tuple""" 
        pass

    def get_subdiag_diff(self, env, pos, vel):
        """ Return the subdiagonal of the jacobian matrix for a single vehicle """ 
        pass

    def get_action_diff(self, env, pos, vel):
        ...
        accel = self.get_accel_diff(env, pos, vel)
    ...
    def get_d_action(self, env): 
        return self.get_d_accel(env)
